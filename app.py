...
# --- 2. DYNAMIC THEME & VISIBILITY ---
st.sidebar.markdown("### 🌓 DISPLAY SETTINGS")
dark_mode = st.sidebar.toggle("Dark Mode", value=True)

# High-contrast logic for accessibility
if dark_mode:
...
# --- 3. COMPLETE EXERCISE DATABASE (54 DRILLS) ---
def get_workout_template(sport, locs):
    workouts = {
        ...
        "Softball": [
            ...
            {"ex": "LONG TOSS", "desc": "Arm strength and distance.", "sets": 3, "base": 15, "unit": "throws", "rest": 60, "loc": "Softball Field", "demo": "https://www.youtube.com/watch?v=C7L7O7w_SxA", "focus": ["Arc", "Follow Through", "Snap"]},
            {"ex": "TWO-BALL FOCUS", "desc": "Vision drill for selective hitting.", "sets": 4, "base": 10, "unit": "swings", "rest": 60, "loc": "Batting Cages", "demo": "https://www.youtube.com/watch?v=leDfLWdAZQk", "focus": ["Vision", "Reaction", "Level Path"]},
            {"ex": "SQUAT JUMPS", "desc": "Explosive lower body drive.", "sets": 3, "base": 12, "unit": "reps", "rest": 60, "loc": "Weight Room", "demo": "https://www.youtube.com/watch?v=72BSZupb0_I", "focus": ["Power", "Land", "Hips"]},
            {"ex": "SPRINT TO FIRST", "desc": "Max speed burst to the bag.", "sets": 6, "base": 1, "unit": "sprint", "rest": 45, "loc": "Softball Field", "demo": "https://www.youtube.com/watch?v=hG76p7v-j_U", "focus": ["Burst", "Finish", "Arms"]},
            {"ex": "BUNTING DRILLS", "desc": "Precision bat control and deadening.",
