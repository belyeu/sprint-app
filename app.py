...
st.markdown(f"""
    ...
    /* SIDEBAR & DROPDOWN VISIBILITY FIX */
    [data-testid="stSidebar"] {{
        background-color: {sidebar_bg} !important;
    }}
    
    /* Force visibility on sidebar text and labels */
    [data-testid="stSidebar"] *, [data-testid="stSidebar"] p, [data-testid="stSidebar"] label, [data-testid="stSidebar"] span {{
        color: {sidebar_text} !important;
        opacity: 1 !important;
    }}

    /* Specific fix for Selectbox/Dropdown visibility on iPhone & Dark Mode */
    ...
    /* Ensure the text inside the dropdown list is visible */
    ul[role="listbox"] li {{
        background-color: {input_bg} !important;
        color: {input_text} !important;
    }}
