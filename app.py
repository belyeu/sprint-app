...
if dark_mode:
    ...
    input_bg = "#1E293B" # Darker background for laptop dark mode fix
    # Force black text for sport selection in dark mode
    sport_text_color = "#000000"
    # Numeric text color in dark mode
    ...
    input_bg = "#FFFFFF"
    # Force white text for sport selection and numeric inputs on iPhone in light mode
    sport_text_color = "#FFFFFF"
    numeric_color = "#FFFFFF"

st.markdown(f"""
    <style>
    /* Fix laptop dark mode white background issue */
    ...
    /* General Input Container fix for laptop */
