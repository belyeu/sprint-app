...
if dark_mode:
    ...
    stat_val_color = "#FFFFFF" # White text for dark mode
else:
    ...
    stat_val_color = "#1E293B" # Deep slate for visibility in light mode
...
st.markdown(f"""
    ...
    /* FIX: Specific color for the numeric values to ensure visibility in Light Mode */
